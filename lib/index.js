...
exports.helloWorld2 = exports.helloWorld = exports.bookService = void 0;
...
function validateUser(context) {
    ...
    if (!context.auth.token.email) {
        throw new functions.https.HttpsError("failed-precondition", "user has no email id please update your profile");
    }
